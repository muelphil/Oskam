...
class Adafruit_Thermal(Serial):
	...
	def __init__(self, *args, **kwargs):
		...
		self.firmwareVersion = kwargs.get('firmware', 106)
		...
		if self.writeToStdout is False:
			...
			heatTime = 160 # eigentlich 120 - für die illumiation variante hatte ich 160 verwendet
			self.writeBytes(
			  27,       # Esc
			  55,       # 7 (print settings)
			  11,       # Heat dots - default 11
			  heatTime, # Lib default - default 120
	      40)       # Heat interval - default 40 
